                ...
                ZStack {
                    HStack {
                        ...
                        .sheet(isPresented: $showingCredits) {
                            SheetView(viewModel: viewModel, timers: $timers, timer: timers.first ?? templateTimers[0])
        ...
        ZStack {
            ...
            VStack(spacing: 5) {
                ...
                Button("დამატება") {
                    ...
                    let newTimer = myTimer(duration: duration, name: timerName, id: UUID(), remainingTime: totalSeconds, initialTime: totalSeconds, timerHistory: [])
...
#Preview {
    MainView(viewModel: TimerViewModel(timers: []))
}
